-- سكربت معدل بواسطة MOJTABA TikTok: jn.__7
-- MOJTABA 1.18.2 تم ترجمته بلكامل
...
local Converted = {
	["_MOJTABA"] = Instance.new("واجهة اللعبة");
	["_فتح"] = Instance.new("TextButton");
	["_UICorner"] = Instance.new("UICorner");
	["_Initفتح"] = Instance.new("LocalScript");
	...
	["_الإشعارات"] = Instance.new("Frame");
	["_UIListLayout"] = Instance.new("UIListLayout");
	["_UIPadding1"] = Instance.new("UIPadding");
	["_نص مؤقت"] = Instance.new("Frame");
	["_UICorner2"] = Instance.new("UICorner");
	["_تسمية"] = Instance.new("تسمية");
	["_صندوق نصنص مؤقت"] = Instance.new("Frame");
	["_UIListLayout1"] = Instance.new("UIListLayout");
	["_TextButton"] = Instance.new("TextButton");
	["_UICorner3"] = Instance.new("UICorner");
	["_UIPadding2"] = Instance.new("UIPadding");
	["_صندوق نص"] = Instance.new("صندوق نص");
	["_UICorner4"] = Instance.new("UICorner");
	["_زر عائم"] = Instance.new("TextButton");
	["_UIPadding3"] = Instance.new("UIPadding");
	["_UICorner5"] = Instance.new("UICorner");
	["_Keybinding"] = Instance.new("LocalScript");
	["_UIStroke"] = Instance.new("UIStroke");
	["_Invisible"] = Instance.new("LocalScript");
	["_زر عائمs"] = Instance.new("Frame");
	["_إضافةCustomModule"] = Instance.new("Frame");
	["_UICorner6"] = Instance.new("UICorner");
	["_UIStroke1"] = Instance.new("UIStroke");
	["_UIGradient"] = Instance.new("UIGradient");
	["_UIGradient1"] = Instance.new("UIGradient");
	["_UIScale"] = Instance.new("UIScale");
	["_تسمية1"] = Instance.new("تسمية");
	["_صندوق نص1"] = Instance.new("صندوق نص");
	["_UICorner7"] = Instance.new("UICorner");
	["_UIPadding4"] = Instance.new("UIPadding");
	["_تسمية2"] = Instance.new("تسمية");
	["_إضافة"] = Instance.new("TextButton");
	["_UICorner8"] = Instance.new("UICorner");
	["_UIPadding5"] = Instance.new("UIPadding");
	["_UIStroke2"] = Instance.new("UIStroke");
	["_LocalScript"] = Instance.new("LocalScript");
	["_إلغاء"] = Instance.new("TextButton");
	["_UICorner9"] = Instance.new("UICorner");
	["_UIPadding6"] = Instance.new("UIPadding");
	["_UIStroke3"] = Instance.new("UIStroke");
	["_LocalScript1"] = Instance.new("LocalScript");
	["_واجهة السلاح الساقط"] = Instance.new("BillboardGui");
	["_تسمية3"] = Instance.new("تسمية");
	["_UIStroke4"] = Instance.new("UIStroke");
	["_واجهة القاتل"] = Instance.new("BillboardGui");
	["_تسمية4"] = Instance.new("تسمية");
	...
	["_إضافةCustomModule1"] = Instance.new("TextButton");
	...
	["_HubCredits"] = Instance.new("تسمية");
	["_HubDesc"] = Instance.new("تسمية");
	["_HubName"] = Instance.new("تسمية");
	["_CanvasGroup"] = Instance.new("CanvasGroup");
	["_UICorner14"] = Instance.new("UICorner");
	["_ImageLabel"] = Instance.new("ImageLabel");
	["_فتحer"] = Instance.new("TextButton");
	["_تسمية5"] = Instance.new("تسمية");
	["_Area"] = Instance.new("Frame");
	["_Area1"] = Instance.new("ScrollingFrame");
	["_تسمية6"] = Instance.new("تسمية");
	["_تسمية7"] = Instance.new("تسمية");
	["_UIGradient5"] = Instance.new("UIGradient");
	["_CloseArea"] = Instance.new("TextButton");
	["_Frame"] = Instance.new("Frame");
	["_UICorner15"] = Instance.new("UICorner");
	["_Closeفتح"] = Instance.new("LocalScript");
	["_تسمية8"] = Instance.new("تسمية");
	...
	["_DialogTitle"] = Instance.new("تسمية");
	["_UIListLayout6"] = Instance.new("UIListLayout");
	["_DialogDesc"] = Instance.new("تسمية");
	...
	["_Optionنص مؤقت"] = Instance.new("TextButton");
...
Converted["_MOJTABA"].DisplayOrder = 3
Converted["_MOJTABA"].IgnoreGuiInset = true
Converted["_MOJTABA"].ScreenInsets = Enum.ScreenInsets.DeviceSafeInsets
Converted["_MOJTABA"].ResetOnSpawn = false
Converted["_MOJTABA"].ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Converted["_MOJTABA"].Name = "MOJTABA"
Converted["_MOJTABA"].Parent = game:GetService("CoreGui")

Converted["_فتح"].Font = Enum.Font.Gotham
Converted["_فتح"].Text = "Triple-click this region to open MOJTABA."
Converted["_فتح"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_فتح"].TextScaled = true
Converted["_فتح"].TextSize = 14
Converted["_فتح"].TextTransparency = 1
Converted["_فتح"].TextWrapped = true
Converted["_فتح"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_فتح"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_فتح"].BackgroundTransparency = 1
Converted["_فتح"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_فتح"].BorderSizePixel = 0
Converted["_فتح"].Position = UDim2.new(0.499372631, 0, 0.06341701, 0)
Converted["_فتح"].Selectable = false
Converted["_فتح"].Size = UDim2.new(0, 493, 0, 50)
Converted["_فتح"].Visible = false
Converted["_فتح"].Name = "فتح"
Converted["_فتح"].Parent = Converted["_MOJTABA"]

Converted["_UICorner"].Parent = Converted["_فتح"]
...
Converted["_UIPadding"].Parent = Converted["_فتح"]

Converted["_ListButton"].Font = Enum.Font.Gotham
Converted["_ListButton"].Text = "نص مؤقت"
...
Converted["_ListButton"].Parent = Converted["_MOJTABA"]

Converted["_UICorner1"].Parent = Converted["_ListButton"]

Converted["_الإشعارات"].AnchorPoint = Vector2.new(1, 0.5)
Converted["_الإشعارات"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_الإشعارات"].BackgroundTransparency = 1
Converted["_الإشعارات"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_الإشعارات"].BorderSizePixel = 0
Converted["_الإشعارات"].Position = UDim2.new(0.99000001, 0, 0.5, 0)
Converted["_الإشعارات"].Size = UDim2.new(0, 242, 1, 0)
Converted["_الإشعارات"].Name = "الإشعارات"
Converted["_الإشعارات"].Parent = Converted["_MOJTABA"]
...
Converted["_UIListLayout"].Parent = Converted["_الإشعارات"]

Converted["_UIPadding1"].PaddingBottom = UDim.new(0, 10)
Converted["_UIPadding1"].PaddingLeft = UDim.new(0, 10)
Converted["_UIPadding1"].Parent = Converted["_الإشعارات"]

Converted["_نص مؤقت"].AnchorPoint = Vector2.new(0.5, 0)
Converted["_نص مؤقت"].BackgroundColor3 = Color3.fromRGB(31.000001952052116, 31.000001952052116, 31.000001952052116)
Converted["_نص مؤقت"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_نص مؤقت"].BorderSizePixel = 0
Converted["_نص مؤقت"].Position = UDim2.new(0.0450000018, 0, 0.112000003, 0)
Converted["_نص مؤقت"].Visible = false
Converted["_نص مؤقت"].Name = "نص مؤقت"
Converted["_نص مؤقت"].Parent = Converted["_الإشعارات"]

Converted["_UICorner2"].Parent = Converted["_نص مؤقت"]

Converted["_تسمية"].Font = Enum.Font.Gotham
Converted["_تسمية"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية"].TextScaled = true
Converted["_تسمية"].TextSize = 14
Converted["_تسمية"].TextWrapped = true
Converted["_تسمية"].TextXAlignment = Enum.TextXAlignment.Left
Converted["_تسمية"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_تسمية"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية"].BackgroundTransparency = 1
Converted["_تسمية"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية"].BorderSizePixel = 0
Converted["_تسمية"].Position = UDim2.new(0.5, 0, 0.5, 0)
Converted["_تسمية"].Size = UDim2.new(0.899999976, 0, 0.800000012, 0)
Converted["_تسمية"].Parent = Converted["_نص مؤقت"]

Converted["_صندوق نصنص مؤقت"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_صندوق نصنص مؤقت"].BackgroundTransparency = 1
Converted["_صندوق نصنص مؤقت"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_صندوق نصنص مؤقت"].BorderSizePixel = 0
Converted["_صندوق نصنص مؤقت"].Size = UDim2.new(1, 0, 0, 50)
Converted["_صندوق نصنص مؤقت"].Visible = false
Converted["_صندوق نصنص مؤقت"].Name = "صندوق نصنص مؤقت"
Converted["_صندوق نصنص مؤقت"].Parent = Converted["_MOJTABA"]
...
Converted["_UIListLayout1"].Parent = Converted["_صندوق نصنص مؤقت"]
...
Converted["_TextButton"].Parent = Converted["_صندوق نصنص مؤقت"]
...
Converted["_صندوق نص"].Font = Enum.Font.Gotham
Converted["_صندوق نص"].نص مؤقتText = "نص مؤقت"
Converted["_صندوق نص"].Text = ""
Converted["_صندوق نص"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_صندوق نص"].TextSize = 14
Converted["_صندوق نص"].TextWrapped = true
Converted["_صندوق نص"].BackgroundColor3 = Color3.fromRGB(22.000000588595867, 22.000000588595867, 22.000000588595867)
Converted["_صندوق نص"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_صندوق نص"].BorderSizePixel = 0
Converted["_صندوق نص"].Size = UDim2.new(0.800000012, 0, 0, 50)
Converted["_صندوق نص"].Parent = Converted["_صندوق نصنص مؤقت"]

Converted["_UICorner4"].Parent = Converted["_صندوق نص"]

Converted["_زر عائم"].Font = Enum.Font.Unknown
Converted["_زر عائم"].Text = "Shoot into murderer"
Converted["_زر عائم"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_زر عائم"].TextScaled = true
Converted["_زر عائم"].TextSize = 14
Converted["_زر عائم"].TextWrapped = true
Converted["_زر عائم"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_زر عائم"].BackgroundColor3 = Color3.fromRGB(31.000001952052116, 31.000001952052116, 31.000001952052116)
Converted["_زر عائم"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_زر عائم"].BorderSizePixel = 0
Converted["_زر عائم"].Position = UDim2.new(0, 125, 0, 40)
Converted["_زر عائم"].Size = UDim2.new(0, 50, 0, 100)
Converted["_زر عائم"].Visible = false
Converted["_زر عائم"].Name = "زر عائم"
Converted["_زر عائم"].Parent = Converted["_MOJTABA"]
...
Converted["_UIPadding3"].Parent = Converted["_زر عائم"]

Converted["_UICorner5"].Parent = Converted["_زر عائم"]

Converted["_UIStroke"].ApplyStrokeMode = Enum.ApplyStrokeMode.Border
Converted["_UIStroke"].Color = Color3.fromRGB(255, 255, 255)
Converted["_UIStroke"].Parent = Converted["_زر عائم"]

Converted["_زر عائمs"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_زر عائمs"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_زر عائمs"].BackgroundTransparency = 1
Converted["_زر عائمs"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_زر عائمs"].BorderSizePixel = 0
Converted["_زر عائمs"].Position = UDim2.new(0.5, 0, 0.5, 0)
Converted["_زر عائمs"].Size = UDim2.new(1, 0, 1, 0)
Converted["_زر عائمs"].ZIndex = 3
Converted["_زر عائمs"].Name = "زر عائمs"
Converted["_زر عائمs"].Parent = Converted["_MOJTABA"]

Converted["_إضافةCustomModule"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_إضافةCustomModule"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_إضافةCustomModule"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_إضافةCustomModule"].BorderSizePixel = 0
Converted["_إضافةCustomModule"].ClipsDescendants = true
Converted["_إضافةCustomModule"].Position = UDim2.new(0.5, 0, -0.5, 0)
Converted["_إضافةCustomModule"].Size = UDim2.new(0, 440, 0, 268)
Converted["_إضافةCustomModule"].ZIndex = 3
Converted["_إضافةCustomModule"].Name = "إضافةCustomModule"
Converted["_إضافةCustomModule"].Parent = Converted["_MOJTABA"]

Converted["_UICorner6"].Parent = Converted["_إضافةCustomModule"]

Converted["_UIStroke1"].Color = Color3.fromRGB(255, 255, 255)
Converted["_UIStroke1"].Thickness = 2
Converted["_UIStroke1"].Parent = Converted["_إضافةCustomModule"]
...
Converted["_UIGradient1"].Parent = Converted["_إضافةCustomModule"]

Converted["_UIScale"].Parent = Converted["_إضافةCustomModule"]

Converted["_تسمية1"].Font = Enum.Font.Gotham
Converted["_تسمية1"].Text = "إضافة a module"
Converted["_تسمية1"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية1"].TextScaled = true
Converted["_تسمية1"].TextSize = 14
Converted["_تسمية1"].TextWrapped = true
Converted["_تسمية1"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_تسمية1"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية1"].BackgroundTransparency = 1
Converted["_تسمية1"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية1"].BorderSizePixel = 0
Converted["_تسمية1"].Position = UDim2.new(0.352256238, 0, 0.133915231, 0)
Converted["_تسمية1"].Size = UDim2.new(0.619047642, 0, 0.125920027, 0)
Converted["_تسمية1"].Parent = Converted["_إضافةCustomModule"]

Converted["_صندوق نص1"].ClearTextOnFocus = false
Converted["_صندوق نص1"].Font = Enum.Font.Gotham
Converted["_صندوق نص1"].نص مؤقتText = "Custom module link"
Converted["_صندوق نص1"].Text = ""
Converted["_صندوق نص1"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_صندوق نص1"].TextScaled = true
Converted["_صندوق نص1"].TextSize = 14
Converted["_صندوق نص1"].TextWrapped = true
Converted["_صندوق نص1"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_صندوق نص1"].BackgroundColor3 = Color3.fromRGB(22.000000588595867, 22.000000588595867, 22.000000588595867)
Converted["_صندوق نص1"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_صندوق نص1"].BorderSizePixel = 0
Converted["_صندوق نص1"].Position = UDim2.new(0.499648541, 0, 0.500059664, 0)
Converted["_صندوق نص1"].Size = UDim2.new(0.804988742, 0, 0.544776142, 0)
Converted["_صندوق نص1"].Parent = Converted["_إضافةCustomModule"]

Converted["_UICorner7"].Parent = Converted["_صندوق نص1"]
...
Converted["_UIPadding4"].Parent = Converted["_صندوق نص1"]

Converted["_تسمية2"].Font = Enum.Font.Gotham
Converted["_تسمية2"].Text = "Only add modules you trust!"
Converted["_تسمية2"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية2"].TextScaled = true
Converted["_تسمية2"].TextSize = 14
Converted["_تسمية2"].TextWrapped = true
Converted["_تسمية2"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_تسمية2"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية2"].BackgroundTransparency = 1
Converted["_تسمية2"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية2"].BorderSizePixel = 0
Converted["_تسمية2"].Position = UDim2.new(0.499648541, 0, 0.833542168, 0)
Converted["_تسمية2"].Size = UDim2.new(0.619047642, 0, 0.0550245307, 0)
Converted["_تسمية2"].Parent = Converted["_إضافةCustomModule"]

Converted["_إضافة"].Font = Enum.Font.Gotham
Converted["_إضافة"].Text = "إضافة"
Converted["_إضافة"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_إضافة"].TextScaled = true
Converted["_إضافة"].TextSize = 14
Converted["_إضافة"].TextWrapped = true
Converted["_إضافة"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_إضافة"].BackgroundColor3 = Color3.fromRGB(50.00000461935997, 50.00000461935997, 50.00000461935997)
Converted["_إضافة"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_إضافة"].BorderSizePixel = 0
Converted["_إضافة"].Position = UDim2.new(0.108492024, 0, 0.927298486, 0)
Converted["_إضافة"].Size = UDim2.new(0.163265288, 0, 0.0858208984, 0)
Converted["_إضافة"].Name = "إضافة"
Converted["_إضافة"].Parent = Converted["_إضافةCustomModule"]

Converted["_UICorner8"].Parent = Converted["_إضافة"]
...
Converted["_UIPadding5"].Parent = Converted["_إضافة"]

Converted["_UIStroke2"].ApplyStrokeMode = Enum.ApplyStrokeMode.Border
Converted["_UIStroke2"].Color = Color3.fromRGB(255, 255, 255)
Converted["_UIStroke2"].Parent = Converted["_إضافة"]

Converted["_إلغاء"].Font = Enum.Font.Gotham
Converted["_إلغاء"].Text = "إلغاء"
Converted["_إلغاء"].TextColor3 = Color3.fromRGB(255, 0, 0)
Converted["_إلغاء"].TextScaled = true
Converted["_إلغاء"].TextSize = 14
Converted["_إلغاء"].TextWrapped = true
Converted["_إلغاء"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_إلغاء"].BackgroundColor3 = Color3.fromRGB(50.00000461935997, 50.00000461935997, 50.00000461935997)
Converted["_إلغاء"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_إلغاء"].BorderSizePixel = 0
Converted["_إلغاء"].Position = UDim2.new(0.899875283, 0, 0.931029797, 0)
Converted["_إلغاء"].Size = UDim2.new(0.163265288, 0, 0.0858208984, 0)
Converted["_إلغاء"].Name = "إلغاء"
Converted["_إلغاء"].Parent = Converted["_إضافةCustomModule"]

Converted["_UICorner9"].Parent = Converted["_إلغاء"]
...
Converted["_UIPadding6"].Parent = Converted["_إلغاء"]

Converted["_UIStroke3"].ApplyStrokeMode = Enum.ApplyStrokeMode.Border
Converted["_UIStroke3"].Color = Color3.fromRGB(255, 0, 0)
Converted["_UIStroke3"].Parent = Converted["_إلغاء"]

Converted["_واجهة السلاح الساقط"].Active = true
Converted["_واجهة السلاح الساقط"].AlwaysOnTop = true
Converted["_واجهة السلاح الساقط"].ClipsDescendants = true
Converted["_واجهة السلاح الساقط"].Size = UDim2.new(0, 70, 0, 70)
Converted["_واجهة السلاح الساقط"].Enabled = false
Converted["_واجهة السلاح الساقط"].ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Converted["_واجهة السلاح الساقط"].Name = "واجهة السلاح الساقط"
Converted["_واجهة السلاح الساقط"].Parent = Converted["_MOJTABA"]

Converted["_تسمية3"].Font = Enum.Font.SourceSansBold
Converted["_تسمية3"].Text = "Dropped Gun!"
Converted["_تسمية3"].TextColor3 = Color3.fromRGB(255, 225.00001698732376, 0)
Converted["_تسمية3"].TextScaled = true
Converted["_تسمية3"].TextSize = 14
Converted["_تسمية3"].TextWrapped = true
Converted["_تسمية3"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_تسمية3"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية3"].BackgroundTransparency = 1
Converted["_تسمية3"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية3"].BorderSizePixel = 0
Converted["_تسمية3"].Position = UDim2.new(0.5, 0, 0.5, 0)
Converted["_تسمية3"].Size = UDim2.new(1, 0, 1, 0)
Converted["_تسمية3"].Parent = Converted["_واجهة السلاح الساقط"]

Converted["_UIStroke4"].Parent = Converted["_تسمية3"]

Converted["_واجهة القاتل"].Active = true
Converted["_واجهة القاتل"].AlwaysOnTop = true
Converted["_واجهة القاتل"].ClipsDescendants = true
Converted["_واجهة القاتل"].MaxDistance = 99999
Converted["_واجهة القاتل"].Size = UDim2.new(0, 70, 0, 70)
Converted["_واجهة القاتل"].StudsOffset = Vector3.new(0, 2, 2)
Converted["_واجهة القاتل"].Enabled = false
Converted["_واجهة القاتل"].ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Converted["_واجهة القاتل"].Name = "واجهة القاتل"
Converted["_واجهة القاتل"].Parent = Converted["_MOJTABA"]

Converted["_تسمية4"].Font = Enum.Font.SourceSansBold
Converted["_تسمية4"].Text = "Murderer"
Converted["_تسمية4"].TextColor3 = Color3.fromRGB(255, 0, 4.000000236555934)
Converted["_تسمية4"].TextScaled = true
Converted["_تسمية4"].TextSize = 14
Converted["_تسمية4"].TextWrapped = true
Converted["_تسمية4"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_تسمية4"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية4"].BackgroundTransparency = 1
Converted["_تسمية4"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية4"].BorderSizePixel = 0
Converted["_تسمية4"].Position = UDim2.new(0.5, 0, 0.5, 0)
Converted["_تسمية4"].Size = UDim2.new(1, 0, 1, 0)
Converted["_تسمية4"].Parent = Converted["_واجهة القاتل"]

Converted["_UIStroke5"].Parent = Converted["_تسمية4"]
...
Converted["_Menu"].Parent = Converted["_MOJTABA"]
...
Converted["_إضافةCustomModule1"].Font = Enum.Font.Gotham
Converted["_إضافةCustomModule1"].Text = "إضافة module"
Converted["_إضافةCustomModule1"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_إضافةCustomModule1"].TextScaled = true
Converted["_إضافةCustomModule1"].TextSize = 14
Converted["_إضافةCustomModule1"].TextWrapped = true
Converted["_إضافةCustomModule1"].AnchorPoint = Vector2.new(0.5, 1)
Converted["_إضافةCustomModule1"].BackgroundColor3 = Color3.fromRGB(50.00000461935997, 50.00000461935997, 50.00000461935997)
Converted["_إضافةCustomModule1"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_إضافةCustomModule1"].BorderSizePixel = 0
Converted["_إضافةCustomModule1"].Position = UDim2.new(0.5, 0, 1, 0)
Converted["_إضافةCustomModule1"].Size = UDim2.new(1, 0, 0, 30)
Converted["_إضافةCustomModule1"].Name = "إضافةCustomModule"
Converted["_إضافةCustomModule1"].Parent = Converted["_List"]

Converted["_UICorner12"].Parent = Converted["_إضافةCustomModule1"]
...
Converted["_HubName"].Text = "MOJTABA"
...
Converted["_فتحer"].Font = Enum.Font.SourceSans
Converted["_فتحer"].Text = ""
Converted["_فتحer"].TextColor3 = Color3.fromRGB(0, 0, 0)
Converted["_فتحer"].TextSize = 14
Converted["_فتحer"].AutoButtonColor = false
Converted["_فتحer"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_فتحer"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_فتحer"].BorderSizePixel = 0
Converted["_فتحer"].Size = UDim2.new(1, 0, 1, 0)
Converted["_فتحer"].Name = "فتحer"
Converted["_فتحer"].Parent = Converted["_CanvasGroup"]

Converted["_تسمية5"].Font = Enum.Font.GothamBold
Converted["_تسمية5"].Text = "Yet Another Random Hub Menu"
Converted["_تسمية5"].TextColor3 = Color3.fromRGB(255, 69.00000348687172, 67.00000360608101)
Converted["_تسمية5"].TextScaled = true
Converted["_تسمية5"].TextSize = 14
Converted["_تسمية5"].TextWrapped = true
Converted["_تسمية5"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية5"].BackgroundTransparency = 1
Converted["_تسمية5"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية5"].BorderSizePixel = 0
Converted["_تسمية5"].Position = UDim2.new(0.204081595, 0, 0.447761208, 0)
Converted["_تسمية5"].Size = UDim2.new(0, 260, 0, 27)
Converted["_تسمية5"].ZIndex = 3
Converted["_تسمية5"].Parent = Converted["_CanvasGroup"]
...
Converted["_تسمية6"].Font = Enum.Font.GothamBold
Converted["_تسمية6"].Text = "happy spooky season"
Converted["_تسمية6"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية6"].TextSize = 14
Converted["_تسمية6"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_تسمية6"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية6"].BackgroundTransparency = 1
Converted["_تسمية6"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية6"].BorderSizePixel = 0
Converted["_تسمية6"].Position = UDim2.new(0.4923051, 0, 0.46438089, 0)
Converted["_تسمية6"].Size = UDim2.new(0, 200, 0, 50)
Converted["_تسمية6"].Parent = Converted["_Area1"]

Converted["_تسمية7"].Font = Enum.Font.GothamBold
Converted["_تسمية7"].Text = "MOJTABA"
Converted["_تسمية7"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية7"].TextScaled = true
Converted["_تسمية7"].TextSize = 14
Converted["_تسمية7"].TextWrapped = true
Converted["_تسمية7"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_تسمية7"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية7"].BackgroundTransparency = 1
Converted["_تسمية7"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية7"].BorderSizePixel = 0
Converted["_تسمية7"].Position = UDim2.new(0.491272807, 0, 0.363785654, 0)
Converted["_تسمية7"].Size = UDim2.new(0, 135, 0, 33)
Converted["_تسمية7"].Parent = Converted["_Area1"]
...
Converted["_تسمية8"].Font = Enum.Font.Gotham
Converted["_تسمية8"].Text = "Tap here to minimize."
Converted["_تسمية8"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية8"].TextSize = 15
Converted["_تسمية8"].TextWrapped = true
Converted["_تسمية8"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_تسمية8"].BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية8"].BackgroundTransparency = 0.4000000059604645
Converted["_تسمية8"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية8"].BorderSizePixel = 0
Converted["_تسمية8"].Position = UDim2.new(0.5, 0, 0.680000007, 0)
Converted["_تسمية8"].Size = UDim2.new(1.39999998, 0, 0.740999997, 0)
Converted["_تسمية8"].Parent = Converted["_CloseArea"]

Converted["_UICorner16"].Parent = Converted["_تسمية8"]
...
Converted["_Toggle"].Parent = Converted["_MOJTABA"]

Converted["_تسمية9"].Font = Enum.Font.Unknown
Converted["_تسمية9"].Text = "Loop walkspeed and FOV"
Converted["_تسمية9"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية9"].TextScaled = true
Converted["_تسمية9"].TextSize = 14
Converted["_تسمية9"].TextWrapped = true
Converted["_تسمية9"].TextXAlignment = Enum.TextXAlignment.Left
Converted["_تسمية9"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية9"].BackgroundTransparency = 1
Converted["_تسمية9"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية9"].BorderSizePixel = 0
Converted["_تسمية9"].Size = UDim2.new(0.699999988, 0, 1, 0)
Converted["_تسمية9"].Parent = Converted["_Toggle"]
...
Converted["_Modules"].Parent = Converted["_MOJTABA"]
...
Converted["_DropdownFrameSample"].Parent = Converted["_MOJTABA"]
...
Converted["_Range"].Parent = Converted["_MOJTABA"]

Converted["_تسمية10"].Font = Enum.Font.Unknown
Converted["_تسمية10"].Text = "How many #### I give"
Converted["_تسمية10"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية10"].TextScaled = true
Converted["_تسمية10"].TextSize = 14
Converted["_تسمية10"].TextWrapped = true
Converted["_تسمية10"].TextXAlignment = Enum.TextXAlignment.Left
Converted["_تسمية10"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية10"].BackgroundTransparency = 1
Converted["_تسمية10"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية10"].BorderSizePixel = 0
Converted["_تسمية10"].Size = UDim2.new(0.699999988, 0, 1, 0)
Converted["_تسمية10"].Parent = Converted["_Range"]
...
Converted["_Dialog"].Parent = Converted["_MOJTABA"]
...
Converted["_Optionنص مؤقت"].Font = Enum.Font.GothamBold
Converted["_Optionنص مؤقت"].RichText = true
Converted["_Optionنص مؤقت"].Text = "aaaaaaaaaaa"
Converted["_Optionنص مؤقت"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_Optionنص مؤقت"].TextScaled = true
Converted["_Optionنص مؤقت"].TextSize = 100
Converted["_Optionنص مؤقت"].TextWrapped = true
Converted["_Optionنص مؤقت"].BackgroundColor3 = Color3.fromRGB(36.00000165402889, 36.00000165402889, 36.00000165402889)
Converted["_Optionنص مؤقت"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_Optionنص مؤقت"].BorderSizePixel = 0
Converted["_Optionنص مؤقت"].Size = UDim2.new(0.532000005, -5, 1.00899994, 0)
Converted["_Optionنص مؤقت"].Visible = false
Converted["_Optionنص مؤقت"].Name = "Optionنص مؤقت"
Converted["_Optionنص مؤقت"].Parent = Converted["_Options"]
...
Converted["_UIPadding16"].Parent = Converted["_Optionنص مؤقت"]

Converted["_UICorner25"].Parent = Converted["_Optionنص مؤقت"]
...
Converted["_UIStroke12"].Parent = Converted["_Optionنص مؤقت"]
...
Converted["_NotificationSample"].Parent = Converted["_MOJTABA"]
...
Converted["_تسمية11"].Font = Enum.Font.Gotham
Converted["_تسمية11"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية11"].TextScaled = true
Converted["_تسمية11"].TextSize = 14
Converted["_تسمية11"].TextWrapped = true
Converted["_تسمية11"].TextXAlignment = Enum.TextXAlignment.Left
Converted["_تسمية11"].AnchorPoint = Vector2.new(0.5, 0.5)
Converted["_تسمية11"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_تسمية11"].BackgroundTransparency = 1
Converted["_تسمية11"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_تسمية11"].BorderSizePixel = 0
Converted["_تسمية11"].Position = UDim2.new(0.5, 0, 0.5, 0)
Converted["_تسمية11"].Size = UDim2.new(0.600000024, 0, 0.600000024, 0)
Converted["_تسمية11"].Parent = Converted["_NotificationSample"]

Converted["_UITextSizeConstraint1"].MaxTextSize = 30
Converted["_UITextSizeConstraint1"].Parent = Converted["_تسمية11"]
...
do -- Fake Module: StarterGui.MOJTABA.FUNCTIONS
    local script = Instance.new("ModuleScript")
    script.Name = "FUNCTIONS"
    script.Parent = Converted["_MOJTABA"]
    local function module_script()
		...
		function FUNCTIONSmodule.notification(s, color, icon)
			...
			task.spawn(function()
				...
				notif.تسمية.MaxVisibleGraphemes = 0
				notif.تسمية.Text = s
				...
				ts:Create(notif.تسمية, TweenInfo.new(0.7, Enum.EasingStyle.Cubic, Enum.EasingDirection.InOut), {
		...
		function FUNCTIONSmodule.createزر عائم(item,button,buttonname)
			if not _G.MOJTABA.زر عائمs:FindFirstChild(string.gsub(buttonname, "_", "")) then
		
		
				local newزر عائم = _G.MOJTABA.زر عائم:Clone()
				newزر عائم.Parent = _G.MOJTABA.زر عائمs
				newزر عائم.Name = string.gsub(buttonname, "_", "")
				newزر عائم.Text = string.gsub(buttonname, "_", " ")
				newزر عائم.Visible = true
		
				newزر عائم.MouseButton1Click:Connect(function()
					if lockMode then
				...
				newزر عائم.Position = UDim2.fromOffset(-125, 90)
				--newزر عائم.Size = UDim2.fromOffset(button.AbsoluteSize.X, button.AbsoluteSize.Y)
				task.spawn(function()
					ts:Create(newزر عائم, TweenInfo.new(2, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out), {
						Size = UDim2.fromOffset(200, 50)
					}):Play()
					ts:Create(newزر عائم, TweenInfo.new(0.7, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {
						Position = UDim2.fromOffset(125, 90)
					}):Play()
				end)
		
				floatingButtonDraggers[string.gsub(buttonname, "_", "")] = DraggableObject.new(newزر عائم)
				floatingButtonDraggers[string.gsub(buttonname, "_", "")]:Enable()
		
				local holder = ClickAndHold.new(newزر عائم)
				holder.Holded.Event:Connect(function()
					...
					if not floatingButtonInvisibility[string.gsub(buttonname, "_", "")] then 
						...
						ts:Create(newزر عائم, TweenInfo.new(1, Enum.EasingStyle.Cubic, Enum.EasingDirection.InOut), {
							BackgroundTransparency = 1,
							TextTransparency = 1
						}):Play()
						ts:Create(newزر عائم.UIStroke, TweenInfo.new(1, Enum.EasingStyle.Cubic, Enum.EasingDirection.InOut), {
							Transparency = 1
						}):Play()
					else
				...
				newزر عائم.InputBegan:Connect(function(input)
				...
				task.spawn(function()
					local buttontodestroy = _G.MOJTABA.زر عائمs:FindFirstChild(string.gsub(buttonname, "_", ""))
			...
			for _, item in ipairs(module) do
				...
				elseif item["Type"] == "Button" then
					...
					cah.Holded.Event:Connect(function()
						FUNCTIONSmodule.createزر عائم(item, button, item["Args"][1])
					end)
				...
				elseif item["Type"] == "ButtonGrid" then
					...
					for buttonname, args in item["Args"][2] do
						...
						local cah = ClickAndHold.new(button, 0.5)
						cah.Holded.Event:Connect(function()
							FUNCTIONSmodule.createزر عائم(item, button, buttonname)
						end)
					end
		
		
				elseif item["Type"] == "Input" then
					local cloneinput = _G.MOJTABA.صندوق نصنص مؤقت:Clone()
					cloneinput.Parent = AREA
					cloneinput.Visible = true
		
					cloneinput.صندوق نص.نص مؤقتText = item["Args"][1]
					cloneinput.TextButton.Text = item["Args"][2]
		
					cloneinput.TextButton.MouseButton1Click:Connect(function()
						item["Args"][3](cloneinput.TextButton, cloneinput.صندوق نص.Text)
					end)
				elseif item["Type"] == "Toggle" then
					local clonetoggle = _G.MOJTABA.Toggle:Clone()
					clonetoggle.Parent = AREA
					clonetoggle.Visible = true
		
					clonetoggle.تسمية.Text = item["Args"][1]
				...
				elseif item["Type"] == "Dropdown" then	
					local clonedropdown = _G.MOJTABA.Dropdown:Clone()
					local dropdownFrame = _G.MOJTABA.DropdownFrameSample
					clonedropdown.Parent = AREA
					clonedropdown.Visible = true
		
					clonedropdown.تسمية.Text = item["Args"][1]
		...
		function FUNCTIONSmodule.refreshlist()
			...
			for modulei, module in ipairs(_G.Modules) do
				local success, err = pcall(function()
					local listbutton = _G.MOJTABA.ListButton:Clone()
				...
				if not success then
					warn("[MOJTABA] Error while requiring " .. module.Name .. "!")
					warn(err)
				end
			end
		end
		...
		function FUNCTIONSmodule.dialog(title, description, buttons)
			...
			for _,v in ipairs(dialog.Options:GetChildren()) do
				if v:IsA("TextButton") and v.Name ~= "Optionنص مؤقت" then v:Destroy() end
			end
			for _, button in buttons do
				local newButton = dialog.Options.Optionنص مؤقت:Clone()
		...
		_G.MOJTABAFUNCTIONS = FUNCTIONSmodule
		return FUNCTIONSmodule
		
    end
    fake_module_scripts[script] = module_script
end
do -- Fake Module: StarterGui.MOJTABA.DraggableObject
    local script = Instance.new("ModuleScript")
...
do -- Fake Module: StarterGui.MOJTABA.ClickAndHold
    local script = Instance.new("ModuleScript")
...
local function JQJVD_fake_script() -- Fake Script: StarterGui.MOJTABA.فتح.Initفتح
    local script = Instance.new("LocalScript")
    script.Name = "Initفتح"
    script.Parent = Converted["_فتح"]
    local req = require
...
local function QFRK_fake_script() -- Fake Script: StarterGui.MOJTABA.فتح.OnClick
    local script = Instance.new("LocalScript")
    script.Name = "OnClick"
    script.Parent = Converted["_فتح"]
    local req = require
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		if clickCount == 3 then
			...
			ts:Create(_G.MOJTABA.Menu, TweenInfo.new(0.7, Enum.EasingStyle.Back, Enum.EasingDirection.Out), 
...
local function KBEFORH_fake_script() -- Fake Script: StarterGui.MOJTABA.فتح.Resizer
    local script = Instance.new("LocalScript")
    script.Name = "Resizer"
    script.Parent = Converted["_فتح"]
    local req = require
...
local function VXLACE_fake_script() -- Fake Script: StarterGui.MOJTABA.Init
    local script = Instance.new("LocalScript")
    script.Name = "Init"
    script.Parent = Converted["_MOJTABA"]
    local req = require
	...
	local s, e = pcall(function()
		if get_hidden_gui or gethui then
			...
			print("[MOJTABA] - Using get_hidden_gui for anti-detection.")
		elseif (not is_sirhurt_closure) and (syn and syn.protect_gui) then
			script.Parent.Name = randomString()
			syn.protect_gui(script.Parent)
			script.Parent.Parent = COREGUI
			print("[MOJTABA] - Using syn.protect_gui for anti-detection.")
		elseif COREGUI:FindFirstChild('RobloxGui') then
			script.Parent.Parent = COREGUI.RobloxGui
			print("[MOJTABA] - Using RobloxGui for anti-detection.")
		else
			warn("[MOJTABA] - Using CoreGui as anti-detection. This is the most basic coverage and can still be detected.")
		end
	end)
	
	print("[MOJTABA] - MOJTABA is now in " .. tostring(script.Parent:GetFullName()))
	if not s then
		warn("[MOJTABA] - Attempts at anti-detection failed. Using CoreGui as anti-detection.")
		warn(e)	
	end
	
	printidentity("[MOJTABA] - Your executor level (identity) is")
	
	local getExeName = identifyexecutor or getexecutorname or function() return "Yet Another Roblox Executor v1.2" end
	print("[MOJTABA] - Your executor is " .. getExeName())
	...
	require(script.Parent.FUNCTIONS).notification("Welcome to MOJTABA Astralfire.")
	...
	script.Parent.Menu.CanvasGroup.تسمية.Visible = false
...
local function JGXWB_fake_script() -- Fake Script: StarterGui.MOJTABA.زر عائم.Keybinding
    local script = Instance.new("LocalScript")
    script.Name = "Keybinding"
    script.Parent = Converted["_زر عائم"]
    local req = require
    local require = function(obj)
        local fake = fake_module_scripts[obj]
        if fake then
...
local function MGTT_fake_script() -- Fake Script: StarterGui.MOJTABA.زر عائم.Invisible
    local script = Instance.new("LocalScript")
...
local function TKTMNY_fake_script() -- Fake Script: StarterGui.MOJTABA.إضافةCustomModule.إضافة.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
    script.Parent = Converted["_إضافة"]
    local req = require
    local require = function(obj)
        local fake = fake_module_scripts[obj]
        if fake then
	...
	script.Parent.MouseButton1Click:Connect(function()
		if script.Parent.Parent.صندوق نص.Text == "" then return end
		...
		local newmodule = loadstring(game:HttpGet(script.Parent.Parent.صندوق نص.Text))()
...
local function ZNJPL_fake_script() -- Fake Script: StarterGui.MOJTABA.إضافةCustomModule.إلغاء.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
    script.Parent = Converted["_إلغاء"]
    local req = require
    local require = function(obj)
        local fake = fake_module_scripts[obj]
        if fake then
...
local function FHXBSSY_fake_script() -- Fake Script: StarterGui.MOJTABA.Menu.UIStroke.UIGradient.Animator
    local script = Instance.new("LocalScript")
...
local function PCGAKG_fake_script() -- Fake Script: StarterGui.MOJTABA.Menu.List.AutoSetup
    local script = Instance.new("LocalScript")
	...
	local زر عائمConnectionsMouse = {}
	local زر عائمConnectionsTouch = {}
...
local function HXNHH_fake_script() -- Fake Script: StarterGui.MOJTABA.Menu.List.إضافةCustomModule.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
    script.Parent = Converted["_إضافةCustomModule1"]
    local req = require
    local require = function(obj)
        local fake = fake_module_scripts[obj]
        if fake then
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		ts:Create(script.Parent.Parent.Parent.إضافةCustomModule, TweenInfo.new(0.6, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
			Position = UDim2.fromScale(0.5, 0.5)
		}):Play()
	end)
end
local function DGSNCYE_fake_script() -- Fake Script: StarterGui.MOJTABA.Menu.Close.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	script.Parent.MouseButton1Click:Connect(function()
		ts:Create(_G.MOJTABA.Menu, TweenInfo.new(0.4, Enum.EasingStyle.Circular, Enum.EasingDirection.Out), 
...
local function BVLUONR_fake_script() -- Fake Script: StarterGui.MOJTABA.Menu.CloseArea.Closeفتح
    local script = Instance.new("LocalScript")
    script.Name = "Closeفتح"
	...
	-- Tween the تسمية transparency
	--TweenService:Create(script.Parent.تسمية, TweenInfo.new(20, Enum.EasingStyle.Linear), {
	--	TextTransparency = 1,
	--	BackgroundTransparency = 1
	--}):Play()
	...
	local فتحerMenuDrag = DraggableObject.new(script.Parent.Parent.CanvasGroup.فتحer, menu, false, true)
	فتحerMenuDrag:Enable()
	local فتحerDraggable = true
	...
	MenuDrag.Dragged = function(pos)
		...
		--	textHidden = true
		--	TweenService:Create(script.Parent.تسمية, TweenInfo.new(1, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {
		--		TextTransparency = 1,
		--		BackgroundTransparency = 1
		--	}):Play()
		--end
	...
	فتحerMenuDrag.Dragged = function(pos)
		if فتحerDraggable then
			closedLastPos = pos
			setSpringPosGoal(pos)
		end
	end
	...
	-- فتحer button behavior
	menu.CanvasGroup.فتحer.MouseButton1Click:Connect(function()
...
local function TDXDSDS_fake_script() -- Fake Script: StarterGui.MOJTABA.Flee the Facility
    local script = Instance.new("LocalScript")
...
local function VHCKUS_fake_script() -- Fake Script: StarterGui.MOJTABA.Murder Mystery 2
    local script = Instance.new("LocalScript")
				...
				if not character:FindFirstChild("PlayerESP") then
					...
					task.spawn(function()
						if player == findMurderer() then
							--local mbgui = script.Parent.واجهة القاتل:Clone()
							--mbgui.Enabled = true
							--mbgui.Name = "Appliedواجهة القاتل"
							--mbgui.Parent = _G.MOJTABA
						...
						if a then
							...
							a.Adornee = player.Character or player.Charactedإضافةed:Wait()
						end
					end)
				end
			end
	...
	local fu = require(_G.MOJTABA.FUNCTIONS)
	...
	-- Player ESP
	workspace.Childإضافةed:Connect(function(ch)
	...
	workspace.ChildRemoved:Connect(function(ch)
		if ch == getMap() and playerESP then
			...
			playerData = {}
			if _G.MOJTABA:FindFirstChild("Appliedواجهة القاتل") then _G.MOJTABA:FindFirstChild("Appliedواجهة القاتل"):Destroy() end
			if _G.MOJTABA:FindFirstChild("DGBGUIClone") then _G.MOJTABA:FindFirstChild("DGBGUIClone"):Destroy() end
			for _, v in ipairs(script.Parent:GetChildren()) do if v.Name == "PlayerESP" then v:Destroy() end end
		end
	end)
	
	-- Dropped Gun ESP
	workspace.Descendantإضافةed:Connect(function(ch)
		...
		if gunDropESP and ch.Name == "GunDrop" then
			...
			local bguiclone = script.Parent.واجهة السلاح الساقط:Clone()
			...
			if autoGetDroppedGun then
				...
				localplayer.Backpack.Childإضافةed:Wait()
	...
	table.insert(module, {
		...
		Args = {2, {
			...
			Dropped_Gun = function()
				if gunDropESP then
					gunDropESP = false
					if _G.MOJTABA:FindFirstChild("GunESP") then _G.MOJTABA:FindFirstChild("GunESP"):Destroy() end
					if _G.MOJTABA:FindFirstChild("DGBGUIClone") then _G.MOJTABA:FindFirstChild("DGBGUIClone"):Destroy() end
				else
					gunDropESP = true
			...
			Auto_Shoot_murderer = function()
				...
				if findSheriff() == localplayer and autoShooting then
					...
					repeat
						task.wait(0.1)
						local murderer = findMurderer() or findSheriffThatsNotMe()
						if not murderer then warn("[MOJTABA] > MM2 Autoshoot - No murderer.") continue end
						local murdererPosition = murderer.Character.HumanoidRootPart.Position
						local characterRootPart = localplayer.Character.HumanoidRootPart
	...
	game.Workspace.Childإضافةed:Connect(function(chi)
...
local function COBWDKS_fake_script() -- Fake Script: StarterGui.MOJTABA.Universal
    local script = Instance.new("LocalScript")
	...
	table.insert(module, {
		Type = "Text",
		Args = {"Welcome to MOJTABA! The open, free script hub."}
	})
	...
	table.insert(module, {
		Type = "Button",
		Args = {"Hide MOJTABA", function(Self)
			if uis.KeyboardEnabled then
			...
			elseif uis.AccelerometerEnabled then
				...
				fu.notification("Can't hide MOJTABA!") -- how else are you gonna open???
			end
		end,}
	}
	)
	...
	table.insert(module, {
		...
		Args = {"FPS Boost", function(Self)
			...
			if result == "FPS boost anyway" then
				...
				workspace.Descendantإضافةed:Connect(function(child)
					task.spawn(function()
	...
	table.insert(module, {
		Type = "Button",
		Args = {"فتح developer console (debugging)", function(Self)
			game.StarterGui:SetCore("DevConsoleVisible", true)
			--_G.MOJTABA.فتح.UIStroke.Transparency = 0
			--_G.MOJTABA.فتح.TextTransparency = 0
			--ts:Create(_G.MOJTABA.فتح, TweenInfo.new(1, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {
			--	Position = UDim2.fromScale(0.5, 0.903)
			--}):Play()

			--ts:Create(_G.MOJTABA.فتح.UIStroke, TweenInfo.new(1), {
			--	Transparency = 1
			--}):Play()
			--ts:Create(_G.MOJTABA.فتح, TweenInfo.new(1), {
			--	TextTransparency = 1
			--}):Play()
		end}
	}
	...
	local usernameColors = {
		...
		["MOJTABAplus"] = Color3.fromHex("#f48fff"),
	...
	local mainText = "MOJTABA Developer"
	local mainFont = Enum.Font.GothamBold
	local specialText = "MOJTABA+"
	local specialFont = Enum.Font.GothamBold

	local function createتسمية(player, text, color)
		...
		if head then
			...
			local mainتسمية = Instance.new("BillboardGui")
			mainتسمية.Parent = tagsFolder
			mainتسمية.Name = text == mainText and "DeveloperTag" or "SpecialTag"
			mainتسمية.Size = UDim2.new(5, 0, 1, 0)
			mainتسمية.StudsOffset = Vector3.new(0, 2, 0)
			mainتسمية.Adornee = head
			mainتسمية.AlwaysOnTop = false
			mainتسمية.MaxDistance = math.huge
			mainتسمية.LightInfluence = 0
			if player.Name == "joystick531" then
				mainتسمية.Brightness = 5
			end

			local mainTextElement = Instance.new("تسمية")
			...
			mainTextElement.Parent = mainتسمية
		end
	end

	local function checkForPlayer(player)
		if usernameColors[player.Name] then
			createتسمية(player, mainText, usernameColors[player.Name])
		elseif specialUsernameColors[player.Name] then
			createتسمية(player, specialText, specialUsernameColors[player.Name])
		end
	end

	local function onCharacterإضافةed(player)
		player.Characterإضافةed:Connect(function(character)
	...
	Players.Playerإضافةed:Connect(handlePlayer)

	table.insert(module, {
		Type = "Toggle",
		Args = {"Hide MOJTABA+/Developer tags", function(Self, state)
